  ...
  const i18n = {
    zh: {
      ...
      labels: {
        ...
        sidebarLabel: "侧边栏",
        personaGateTitle: "先选择你的使用身份",
        personaGateSubtitle: "我们会根据你的目标展示更合适的输入流程和报告重点。",
        personaCandidateTitle: "我是候选人",
        personaCandidateDescription: "梳理岗位匹配、项目故事、风险补证和面试表达。",
        personaInterviewerTitle: "我是面试官",
        personaInterviewerDescription: "生成证据链、必问追问、评分表和下一轮传递重点。",
        personaGateHint: "本次使用期间可在页面顶部切换身份；重新打开页面时需要再次选择。",
        advancedModelTitle: "高级设置：模型与代理",
        advancedModelHint: "默认使用 Mock Demo，无需配置即可体验",
      ...
      audienceFlows: {
        candidate: {
          configCardTitle: "设置你的面试目标",
          configCardSubtitle: "先选择目标岗位与面试阶段，模型设置可在高级选项中调整",
          sandbox: "面试目标与 Offer 约束",
          sandboxHint: "用于生成更贴合当前阶段的准备策略",
          inputTitle: "粘贴你的简历与目标 JD",
          inputCardSubtitle: "系统将为你生成项目故事、风险补证和面试表达建议",
          skillCardTitle: "选择想模拟的面试官",
          skillHint: "选择你最可能遇到的角色，提前准备不同视角的追问",
          generateBtn: "生成我的面试准备",
        },
        interviewer: {
          configCardTitle: "设置本轮评估目标",
          configCardSubtitle: "先明确岗位、面试阶段和评估约束，模型设置可在高级选项中调整",
          sandbox: "评估目标与 Offer 约束",
          sandboxHint: "用于校准推进条件、录用风险和谈薪边界",
          inputTitle: "输入候选人简历与岗位 JD",
          inputCardSubtitle: "系统将生成证据链、必问题、评分表和下一轮传递重点",
          skillCardTitle: "组建虚拟面试委员会",
          skillHint: "选择参与评估的角色，让不同视角共同审查候选人证据",
          generateBtn: "生成候选人评估",
        },
      },
      placeholders: {
      ...
      statusCleared: "已清空当前页面中的 Key、输入和报告；本机缓存可在浏览器站点数据中清理。",
      ...
      statusFeedback: "人工反馈已写入当前报告，并保存到本机反馈历史。",
    ...
    en: {
      ...
      labels: {
        ...
        personaGateTitle: "Choose how you will use OfferAgent",
        personaGateSubtitle: "The workspace will adapt its inputs and report priorities to your goal.",
        personaCandidateTitle: "I am a candidate",
        personaCandidateDescription: "Prepare role-fit evidence, project stories, risk gaps, and interview answers.",
        personaInterviewerTitle: "I am an interviewer",
        personaInterviewerDescription: "Build evidence chains, priority questions, scorecards, and handoff notes.",
        personaGateHint: "You can switch roles from the header during this visit. Reopening the page asks again.",
        advancedModelTitle: "Advanced: Model and Proxy",
        advancedModelHint: "Mock Demo works without configuration",
        ...
        runScope: "Saved in this browser",
      ...
      audienceFlows: {
        candidate: {
          configCardTitle: "Set Your Interview Goal",
          configCardSubtitle: "Choose the target role and interview stage first; model settings are under Advanced",
          sandbox: "Interview Goal and Offer Constraints",
          sandboxHint: "Used to tailor preparation advice to the current interview stage",
          inputTitle: "Paste Your Resume and Target JD",
          inputCardSubtitle: "Generate project stories, evidence-gap actions, and interview answer guidance",
          skillCardTitle: "Choose Interviewers to Simulate",
          skillHint: "Select the roles you are most likely to meet and prepare for each perspective",
          generateBtn: "Generate My Interview Prep",
        },
        interviewer: {
          configCardTitle: "Set This Evaluation Goal",
          configCardSubtitle: "Define the role, stage, and constraints first; model settings are under Advanced",
          sandbox: "Evaluation Goal and Offer Constraints",
          sandboxHint: "Used to calibrate progression conditions, hiring risk, and negotiation boundaries",
          inputTitle: "Enter Candidate Resume and Job Description",
          inputCardSubtitle: "Generate evidence chains, priority questions, scorecards, and handoff notes",
          skillCardTitle: "Build the Virtual Interview Panel",
          skillHint: "Choose the evaluators whose perspectives should review the candidate evidence",
          generateBtn: "Generate Candidate Evaluation",
        },
      },
      placeholders: {
      ...
      statusCleared: "Cleared the key, inputs, and report from the current page. Local cache can be cleared from browser site data.",
      ...
      statusFeedback: "Human feedback appended to the current report and saved to local feedback history.",
