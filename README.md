...
当前第一版定位很克制：面试准备助手。它的核心用途是辅助候选人更好准备面试：用户粘贴简历和 JD 后，系统结合 Offer 沙盘上下文与面试官视角库，输出候选人准备重点、岗位匹配、证据链、风险点和可下载报告。同时，它会生成一组可供面试官挑选的候选人追问题库，帮助面试官围绕项目经历和 JD 职责提问。
